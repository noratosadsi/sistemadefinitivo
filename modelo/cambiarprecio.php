...
if ($_POST["motosmin"])
{
	...
	if($mysql->error)
	$error="error actualizando costo por minuto en motos";
	//die (header ("Location: ../vista/precio.php?error=motosmin"));
...
if ($_POST["motosmes"])
{
	...
	header ("Location: ../vista/precio.php?error=motosmes");
}
...
if (isset($_POST["bicicletasmes"]))
{
	...
	header ("Location: ../vista/precio.php?error=bicicletasmes");
}
