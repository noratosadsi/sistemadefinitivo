...
$(document).ready(function() {
 ...
 $('input:radio[name=radio]').click(function() {
	alert("La edad seleccionada es: " + $('input:radio[name=radio]:checked').val());
...
<td>Minutos</td>
<td><input type="radio" name="radio" value="minutos"></td><!--checked="checked"-->
<td></td>
<td>Capacidad</td>
...
<tr>
<td>Horas</td>
<td><input type="radio" name="radio" value="horas" value="horas"></td>
<td></td>
<td>Ocupados</td>
...
<tr>
<td>Dias</td>
<td><input type="radio" name="radio" value="dias"></td>
<td></td>
<td>Disponible</td>
...
<tr>
<td>Mensualidad</td>
<td><input type="radio" name="radio" value="mensualidad"></td>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
<td colspan="3"></td>
<td>Cambio</td>
